...
\[P_\infty[p=1] = \frac{\exp[u_t(w,1)]}{\exp[u_t[w,0]]+\exp[u_t(w,1)]} \]


{\color{red}TODO:
\begin{enumerate}
\item Derive elasticity of labor supply wrt $\tilde{p}_c$
\item Derive treatment effect of time limits on program participation.
\end{enumerate}
}
