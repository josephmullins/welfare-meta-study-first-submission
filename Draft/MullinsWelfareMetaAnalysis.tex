...
%Now consider the case for a mother with $T-t=\Omega-\omega_t+1$. In this case, if she uses time limits today, she will not be able to.

%For a mother who must choose between welfare use today, or welfare use tomorrow, we can derive the effect of the time limit as:
