...
budget1=zeros(3,3,3,Dev_Years,Dev_Years*4,2,2,2)
...
Earnings=zeros(3,Dev_Years*4+1) # I add some extra years for the parents whose kids will age out
...
SNAP=zeros(3,3,Dev_Years*4) # first index is the number of kids, second is site, third is quarter
for i in 1:3
...
Poverty=zeros(3,3,Dev_Years*4)# first index is the number of kids, second is site, third is quarter for compatibility
PovGuideline
for j in 1:3
