...
function Model1(N_sites, N_arms, N_age, budget,budget_ageout,qs, Earn, TimeLimit_Ind,TimeLimits,τ, Work_Reqs, Foodstamps_receipt; πk=ones(N_sites,N_arms).*(1/3),πK=ones(N_sites,N_arms).*(1/3))
	αc=0.5*ones(N_sites)
	αθ=0.5
...
function initialize_model()
	Mod1=Model1(4,3,18,budget1,Budget_Ageout,18*4,Earnings,TimeLimit_Ind,TimeLimits,τ, Work_Reqs_Ind,Foodstamps_receipt)
